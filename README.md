...
| [`visao/`](visao) | **Parcial** | Índice de dano por imagem, integrado ao backend, com 40 testes. O modelo treinado depende de GPU; o estimador clássico roda hoje, com confiança abaixo do limiar de proposito |
